...
<html>
    <head>
        ...
        <!-- App title -->
        <title>وارا نیوز | صفحه درباره ما</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">درباره صفحه  </h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">به روز رسانی و ثبت</button>
