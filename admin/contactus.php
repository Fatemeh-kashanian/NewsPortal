...
<html>
    <head>
        ...
        <!-- App title -->
        <title>وارا نیوز | صفحه ارتباط با ما</title>
		
		<style>
			body{
				direction:rtl;
			}
			a,li,form,label,input,h4{
			    text-align:right;
		    }
		</style>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">صفحه ارتباط با ما</h4>
...
<label for="exampleInputEmail1">عنوان صفحات</label>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>جزئیات صفحه</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">به روزرسانی و ثبت</button>
