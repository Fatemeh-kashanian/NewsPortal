...
<html>
    <head>
        ...
        <title> وارا نیوز| مدیریت کامنت ها</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">مدیریت کامنت های پسندیده</h4>
...
<strong>یه درستی انجام شد</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
                                                    ...
                                                    <table dir="rtl" class="table m-0 table-colored-bordered table-bordered-info">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th scope="col" width="300">کامنت</th>
                                                                 <th scope="col">وضعیت</th>
                                                                <th scope="col">پست / خبر</th>
