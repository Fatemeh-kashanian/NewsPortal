...
<html>
    <head>
        ...
        <title> اخبار | مدیریت زیر موضوع</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">مدیریت زیر موضوع</h4>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">اضافه کردن <i class="mdi mdi-plus-circle-outline" ></i></button>
</a>
 </div>

												<div class="table-responsive">
                                                    <table dir="rtl" class="table m-0 table-colored-bordered table-bordered-info">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col">#</th>
                                                                ...
                                                                <th scope="col">تاریخ پست</th>
                                                                  <th scope="col">تاریخ آخرین پست</th>
...
<td colspan="7" align="center"><h3 style="color:red">گزارشی یافت نشد</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> زیر موضوعات حذف شده</h4>

 </div>

<div class="table-responsive">
   <table dir="rtl" class="table m-0 table-colored-bordered table-bordered-danger">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col">#</th>
                                                                <th scope="col"> موضوع</th>
