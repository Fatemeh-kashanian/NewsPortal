                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">مدیریت پیام های تایید نشده</h4>
										...
										<div class="col-md-12">
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table dir="rtl" class="table m-12 table-colored-bordered table-bordered-info">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col">#</th>
                                                                <th scope="col"> نام</th>
                                                                <th scope="col">ایمیل</th>
                                                                <th scope="col" width="300">پیام</th>
                                                                 <th scope="col">وضعیت</th>
                                                                <th scope="col">پست / اخبار</th>
