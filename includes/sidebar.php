...
<html>
    ...
    <head>
		<style>
			...
			h5,li,.card-header, .card-title, .card-text, .card-footer{
				text-align:right;
			}
		</style>
    ...
    <body>	
		  ...
		  <div class="col-md-4">
				...
				<input type="text" name="searchtitle" class="form-control" placeholder="...جستجو درباره" required>
						<span class="input-group-btn">
						  <button class="btn btn-info" type="submit">برو</button>
						</span>
					  </form>
					  </div>
					</div>
				  ...
				  <!-- Categories Widget -->
				  <div class="card my-4">
					<h5 class="card-header">موضوعات</h5>
					<div class="card-body">
					  <div class="row">
						<div class="col-lg-6">
		...
		<?php } ?>
				  ...
				  <!-- Side Widget -->
				  <div class="card my-4">
					<h5 class="card-header">اخبار تازه</h5>
					<div class="card-body">
							  <ul class="mb-0">
		<?php
